...
// version:
const std::string VERSION = "1.0.8, 2025-09-24";
...
/*----------------------------------------------------------------*/
  ...
  // ------------------
  {
    ...
    // tests for SOLAR6:
    {
      ...
      expected_output =
    	"4136232.10319 41.5648148148 -90697638.129 -368.75421 -34.73144 -87 44.99652957";
    ...
    if ( !fast ) {
      ...
      expected_output =
    	"44298455.5682 0 -81139035.965 -451.54499 -31.908255 -181.947 -13.8870143";
      if ( check_eval ( "SOLAR6", 0, 1.0, 1.0, x, expected_output, error ) )
    	std::cout << "... Ok";
      else {
    	std::cout << "... Fail";
    ...
    if ( !fast ) {
      ...
      expected_output =
    	"46257817.4945 0 -81103180.003 -451.4926 -31.908287 -181.847 -13.90461209";
      if ( check_eval ( "SOLAR6", 0, 1.0, 1.0, x, expected_output, error ) )
    	std::cout << "... Ok";
      else {
    	std::cout << "... Fail";
    ...
    // tests for SOLAR7:
    {
      ...
      expected_output =
    	"-2768.29493993 -30016849.1891 5656779685 -0.001 -47 -10.5555742876 6.49133";
...

    {
      ...
      expected_output =
    	"-4939.4070342 -22502463.2016 -212401980.756 -0.00421692 -119.245 -10.1548952275 -0.0288619";
      if ( check_eval ( "SOLAR7", 0, 1.0, 1.0, x, expected_output, error ) )
    	std::cout << "... Ok";
      else {
    	std::cout << "... Fail";
    ...
    // tests for SOLAR9:
    {
      ...
      expected_output =
	"-763500000001 4.64562784e+10 -1088133975.31 -331500000001 -3613902.13451 -97.939453 -8.5886684441 0 -263540971.585 -386.410223 -55.33238453 -1.1455984573 -0.01133672035 -8.83054238665 -141.0300707 -0.139153532 -0.00124018005 -0.010237410314 -220956570.629";
    ...
    }
    {
      ...
      expected_output =
    	"-758500000001 1.37153949e+11 -1069963889.68 -326500000001 -3936022.83894 -98.1134 -8.581985 0 -230714995.019 -384.896122 -48.62519715 -2.46013500379 -0.0067819 -12.0012035734 -138.748 -0.0191773905 -0.0001346 -0.0126554 -156088978.447";
      if ( check_eval ( "SOLAR9", 0, 1.0, 1.0, x, expected_output, error ) )
    	std::cout << "... Ok";
      else {
    	std::cout << "... Fail";
